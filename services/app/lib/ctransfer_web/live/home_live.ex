defmodule CTransferWeb.HomeLive do
  @moduledoc false
  use CTransferWeb, :live_view

  alias CTransfer.Accounts
  alias CTransferWeb.Presence
  ...
  def mount(_params, session, socket) do
    ...
    Logger.disable(self())
    image_url = Path.join(:code.priv_dir(:ctransfer), "static/images/bridge.png")
    ...
    if connected?(socket) do
      ...
      CTransferWeb.Endpoint.subscribe(@channel_topic)
    end
